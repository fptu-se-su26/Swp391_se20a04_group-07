...
<div class="container mt-4">
    <form action="${pageContext.request.contextPath}/admin/update-student" method="POST">
        ...
        <div class="row card p-4 shadow-sm flex-row">
            <h4 class="mb-4 text-primary w-100">Cập nhật thông tin học sinh</h4>
            
            <div class="col-md-6 mb-3">
                <label class="form-label fw-bold">Mã số học sinh (MSHS)</label>
            ...
            <div class="d-flex gap-2 w-100">
                ...
                <a href="manage-students?classId=${student.classId}" class="btn btn-secondary px-4">Hủy bỏ</a>
            </div>
        </div>
    </form>
</div>
