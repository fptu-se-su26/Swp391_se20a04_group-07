        ...
        <div class="main-content-wrapper">
            ...
            <div class="container-fluid p-4 px-lg-5">
                ...
                <c:if test="${param.msg == 'add_success_linked'}">
                    <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm rounded-4"><i class="fas fa-check-circle me-2"></i>Thêm học sinh thành công! Gmail đã có trên hệ thống, <b>tự động ghép nhóm 2 anh em</b>.<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
                    </c:if>
                    <c:if test="${param.msg == 'add_success_new_parent'}">
                    <div class="alert alert-info alert-dismissible fade show border-0 shadow-sm rounded-4"><i class="fas fa-info-circle me-2"></i>Thêm học sinh thành công! Hệ thống đã <b>tự động khởi tạo ngầm</b> một tài khoản Phụ huynh mới từ Gmail bạn vừa cung cấp.<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
                    </c:if>
