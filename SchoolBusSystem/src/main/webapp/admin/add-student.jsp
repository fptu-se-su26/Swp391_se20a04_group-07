            ...
            <div class="card shadow-sm border-0 rounded-4">
                ...
                <div class="card-body p-4 p-lg-5">
                    <form action="${pageContext.request.contextPath}/admin/add-student" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold text-secondary small text-uppercase">Số điện thoại chính</label>
                                <input type="tel" class="form-control" name="parentPhone" placeholder="Nhập SĐT phụ huynh..." required pattern="[0-9]{9,11}">
                                <small class="text-muted fst-italic">Bắt buộc nhập để nhà trường liên lạc.</small>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" name="studentEmail" placeholder="Nhập Gmail để học sinh tự login...">
                                <small class="text-muted fst-italic">Để trống nếu học sinh còn nhỏ chưa có điện thoại.</small>
                            </div>
                            <div class="col-md-6 mb-3">
